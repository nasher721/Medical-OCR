-- Fix critical pagination bug in search_documents function
-- Bug: LIMIT COALESCE(NULLIF(p_page, 1), 20) was completely wrong
-- Bug: Missing OFFSET clause meant page parameter was ignored
